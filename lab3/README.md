...
`git clone git@github.com:hoowalex/MobileLabsRN2026.git`
...
У застосунку реалізовано мобільну гру-клікер, у якій користувач взаємодіє з основним ігровим об’єктом за допомогою різних жестів. За кожну дію нараховуються очки, а також оновлюється прогрес виконання завдань.
